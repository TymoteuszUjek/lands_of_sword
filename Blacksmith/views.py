...
def blacksmith(request):
    ...
    items_for_sale = Item.objects.filter(shop_type=' Blacksmith').exclude(
    ...
    if request.method == 'POST':
        ...
        if action == 'buy':
            ...
            return HttpResponseRedirect(reverse('Blacksmith:blacksmith'))
    ...
    return render(request, 'Blacksmith/blacksmith.html', context)