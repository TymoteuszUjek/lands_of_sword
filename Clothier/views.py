...
def clothier(request):
    ...
    items_for_sale = Item.objects.filter(shop_type=' Clothier').exclude(
    ...
    if request.method == 'POST':
        ...
        if action == 'buy':
            ...
            return HttpResponseRedirect(reverse('Clothier:clothier'))
    ...
    return render(request, 'Clothier/clothier.html', context)