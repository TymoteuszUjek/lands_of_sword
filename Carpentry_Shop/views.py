...
def carpentry_shop(request):
    ...
    items_for_sale = Item.objects.filter(shop_type=' Carpentry Shop').exclude(
    ...
    if request.method == 'POST':
        ...
        if action == 'buy':
            ...
            return HttpResponseRedirect(reverse('Carpentry_Shop:carpentry_shop'))
    ...
    return render(request, 'Carpentry_Shop/carpentry_shop.html', context)